...
const CartContextProvider = ({ children }: { children: ReactNode }) => {
  ...
  const addCart = (articulo: Articulo) => {
    if (sucursalSeleccionada) {
      ...
      if ((articulo as Promocion).precioPromocional !== undefined && verificarVigenciaPromociones(articulo as Promocion))
        return alert("La promoción no se puede agregar al carrito porque ya no se encuentra vigente");
